...
values=('12','RayRizzo','107','Colorado' , 'Denver'))
my_game.insert(parent='',index='end',iid=12,text='',
values=('13','Byun','108','Pennsylvania' , 'ORVISTON'))
my_game.insert(parent='',index='end',iid=13,text='',
values=('14','Trink','109','Ohio' , 'Cleveland'))
my_game.insert(parent='',index='end',iid=14,text='',
values=('14','Twitch','110','Georgia' , 'Duluth'))
my_game.insert(parent='',index='end',iid=15,text='',
values=('15','Animus','111', 'Connecticut' , 'Hartford'))
my_game.pack()
my_game.config(yscrollcommand=game_scroll.set)
